...
(function(){
  ...
  async function fetchUnverified() {
    ...
    try {
      ...
      data.users.forEach(u => {
        ...
        if (u.roles.includes('Role.VERIFIER')){
          grantBtn.textContent = 'Granted';
          grantBtn.classList.add('btn-success');
          grantBtn.classList.remove('btn-ghost');
          grantBtn.disabled = true;
        }
        grantBtn.addEventListener('click', () => grantUser(u.id, grantBtn));
  ...
  async function grantUser(id, btn) {
    btn.disabled = true;
